#!/usr/bin/env python
# -*- coding: utf-8 -*-
""" \example XT_sensors_firmware_update.py
...
#Command to run: 
# "python XT_sensors_firmware_update.py -f Annapurna_4bl_cert.hex", change "com8" with your device name, using "--help" to see other options.
...
def main():
    ...
    parser.add_option(
        ...
        "--file",
        dest="hex_file_name",
        default="Annapurna_4bl_cert.hex",
    ...
    if options.device_name:
        ...
        try:
            ...
            raise
    upgrade_fw(options.hex_file_name, options.skip_goto, device_name)
    sleep(3)
    display_information(device_name)
